	...
	en: [
		{
			name: 'Itemax',
			period: '2004 - 2006',
			description: 'Technical support and attention to internet service customers',
		},
		{
			name: 'Banco de Corrientes',
			period: '2006 - 2021',
			description: 'Commercial and operational attention to banking clients',
		},
		{
			name: 'Freelance Developer',
			period: '2008 - current',
			description: 'Fullstack and mobile developer in various projects for clients from different industries',
		},
		{
			name: 'Globant',
			period: '2021 - current',
			description: 'Software Developer Ssr Adv. Frontend web development in different projects',
		},
	],
}
